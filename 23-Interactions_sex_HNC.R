...
cox3_int_Sex_HN_Mal_INHANCE_2007_SiteCode_N4 <- cox3_int_Sex_func(data$Agexit_Uadt, data$HN_Mal_INHANCE_2007_SiteCode, data$QE_P_M_N4)
cox3_ref_Sex_HN_Mal_INHANCE_2007_SiteCode_N4 <- cox3_ref_Sex_func(data$Agexit_Uadt, data$HN_Mal_INHANCE_2007_SiteCode, data$QE_P_M_N4)

#run test
anova(cox3_ref_Sex_HN_Mal_INHANCE_2007_SiteCode_N4, cox3_int_Sex_HN_Mal_INHANCE_2007_SiteCode_N4) 


#stratified analysis
  #among males - Sex variable
cox3_int_HN_Mal_INHANCE_2007_SiteCode_Sex_1_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, HN_Mal_INHANCE_2007_SiteCode) ~ QE_P_M_N4 + strata(Cntr_C, Age_Recr_1y) + 
                                                            factor(Smoke_Stat_C) + factor(L_School_C) + factor(Pa_Index_C) + Height_C + Alc_Re, data = data[data$Sex == 1, ]) 
  #among females - Sex variable
cox3_int_HN_Mal_INHANCE_2007_SiteCode_Sex_2_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, HN_Mal_INHANCE_2007_SiteCode) ~ QE_P_M_N4 + strata(Cntr_C, Age_Recr_1y) + 
...
int_Sex_1_HN_Mal_table_N4 <- int_func(cox3_int_HN_Mal_INHANCE_2007_SiteCode_Sex_1_N4, "male", "10% increase in UPF in %g/d", "Head and neck cancer")
int_Sex_2_HN_Mal_table_N4 <- int_func(cox3_int_HN_Mal_INHANCE_2007_SiteCode_Sex_2_N4, "female", "10% increase in UPF in %g/d", "Head and neck cancer")


int_Sex_HN_Mal_table_all <- rbind(int_Sex_1_HN_Mal_table_N4, int_Sex_2_HN_Mal_table_N4) %>% flextable(.)
