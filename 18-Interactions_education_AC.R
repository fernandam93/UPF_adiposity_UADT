...
cox3_int_Educ_categories_Esoph_Mal_Adeno_N4 <- cox3_int_Educ_categories_func(data$Agexit_Uadt, data$Esoph_Mal_Adeno, data$QE_P_M_N4)
cox3_ref_Educ_categories_Esoph_Mal_Adeno_N4 <- cox3_ref_Educ_categories_func(data$Agexit_Uadt, data$Esoph_Mal_Adeno, data$QE_P_M_N4)

#run test
anova(cox3_ref_Educ_categories_Esoph_Mal_Adeno_N4, cox3_int_Educ_categories_Esoph_Mal_Adeno_N4) 


#stratified analysis
  #among primary or less - Educ_categories variable
cox3_int_Esoph_Mal_Adeno_Educ_categories_1_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
cox3_int_Esoph_Mal_Adeno_Educ_categories_2_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
cox3_int_Esoph_Mal_Adeno_Educ_categories_3_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
int_Educ_categories_1_adeno_Mal_table_N4 <- int_func(cox3_int_Esoph_Mal_Adeno_Educ_categories_1_N4, "primary education or less", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")
int_Educ_categories_2_adeno_Mal_table_N4 <- int_func(cox3_int_Esoph_Mal_Adeno_Educ_categories_2_N4, "secondary or technical/professional education", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")
int_Educ_categories_3_adeno_Mal_table_N4 <- int_func(cox3_int_Esoph_Mal_Adeno_Educ_categories_3_N4, "higher education", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")

int_Educ_categories_adeno_Mal_table_all <- rbind(int_Educ_categories_1_adeno_Mal_table_N4, int_Educ_categories_2_adeno_Mal_table_N4, int_Educ_categories_3_adeno_Mal_table_N4) %>% flextable(.)
...
#save %g/d tables
int_Educ_categories_adeno_Mal_table_all %>% 
