...
cox2_int_alc_Esoph_Mal_Adeno_N4 <- cox2_int_alc_func(data$Agexit_Uadt, data$Esoph_Mal_Adeno, data$QE_P_M_N4)
cox2_ref_alc_Esoph_Mal_Adeno_N4 <- cox2_ref_alc_func(data$Agexit_Uadt, data$Esoph_Mal_Adeno, data$QE_P_M_N4)

#run test
anova(cox2_ref_alc_Esoph_Mal_Adeno_N4, cox2_int_alc_Esoph_Mal_Adeno_N4) #no evidence of interaction based on p value


#stratified analysis
  #among non-drinkers and light drinkers - alc_categories variable
cox2_int_Esoph_Mal_Adeno_alc_0_light_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
cox2_int_Esoph_Mal_Adeno_alc_moderate_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
cox2_int_Esoph_Mal_Adeno_alc_heavy_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, Esoph_Mal_Adeno) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
int_alc_light_adeno_Mal_table_N4 <- int_func(cox2_int_Esoph_Mal_Adeno_alc_0_light_N4, "no/light alcohol intake", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")
int_alc_moderate_adeno_Mal_table_N4 <- int_func(cox2_int_Esoph_Mal_Adeno_alc_moderate_N4, "moderate alcohol intake", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")
int_alc_heavy_adeno_Mal_table_N4 <- int_func(cox2_int_Esoph_Mal_Adeno_alc_heavy_N4, "heavy alcohol intake", "10% increase in UPF in %g/d", "Oesophageal adenocarcinoma")


int_alc_adeno_Mal_table_all <- rbind(int_alc_light_adeno_Mal_table_N4, int_alc_moderate_adeno_Mal_table_N4, int_alc_heavy_adeno_Mal_table_N4) %>% flextable(.)
