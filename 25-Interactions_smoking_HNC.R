...
cox3_int_Smoke_Stat_C_HN_Mal_INHANCE_2007_SiteCode_N4 <- cox3_int_Smoke_Stat_C_func(data$Agexit_Uadt, data$HN_Mal_INHANCE_2007_SiteCode, data$QE_P_M_N4)
cox3_ref_Smoke_Stat_C_HN_Mal_INHANCE_2007_SiteCode_N4 <- cox3_ref_Smoke_Stat_C_func(data$Agexit_Uadt, data$HN_Mal_INHANCE_2007_SiteCode, data$QE_P_M_N4)

#run test
anova(cox3_ref_Smoke_Stat_C_HN_Mal_INHANCE_2007_SiteCode_N4, cox3_int_Smoke_Stat_C_HN_Mal_INHANCE_2007_SiteCode_N4) 


#stratified analysis
  #among never - Smoke_Stat_C variable
cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_1_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, HN_Mal_INHANCE_2007_SiteCode) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
                                                               factor(L_School_C) + factor(Pa_Index_C) + Height_C + Alc_Re, data = data[data$Smoke_Stat_C == 1, ]) 
  #among former - Smoke_Stat_C variable
cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_2_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, HN_Mal_INHANCE_2007_SiteCode) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
                                                                factor(L_School_C) + factor(Pa_Index_C) + Height_C + Alc_Re, data = data[data$Smoke_Stat_C == 2, ]) 
#among smoker - Smoke_Stat_C variable
cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_3_N4 <- survival::coxph(Surv(Age_Recr, Agexit_Uadt, HN_Mal_INHANCE_2007_SiteCode) ~ QE_P_M_N4 + strata(Sex, Cntr_C, Age_Recr_1y) + 
...
int_Smoke_Stat_C_1_HN_Mal_table_N4 <- int_func(cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_1_N4, "Never", "10% increase in UPF in %g/d", "Head and neck cancer")
int_Smoke_Stat_C_2_HN_Mal_table_N4 <- int_func(cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_2_N4, "Former", "10% increase in UPF in %g/d", "Head and neck cancer")
int_Smoke_Stat_C_3_HN_Mal_table_N4 <- int_func(cox3_int_HN_Mal_INHANCE_2007_SiteCode_Smoke_Stat_C_3_N4, "Smoker", "10% increase in UPF in %g/d", "Head and neck cancer")


int_Smoke_Stat_C_HN_Mal_table_all <- rbind(int_Smoke_Stat_C_1_HN_Mal_table_N4, int_Smoke_Stat_C_2_HN_Mal_table_N4,int_Smoke_Stat_C_3_HN_Mal_table_N4) %>% flextable(.)
...
#save %g/d tables
int_Smoke_Stat_C_HN_Mal_table_all %>% 
